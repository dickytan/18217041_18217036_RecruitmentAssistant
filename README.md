...
Recruitment Assistant memudahkan pengguna (Human Resource) untuk mendapatkan data-data calon pekerja yang berpotensi untuk di-approach berdasarkan latar belakang edukasi atau domisili. Selain itu, aplikasi ini juga terintegrasi dengan fitur to-do List sehingga tugas-tugas selama proses pencarian calon pekerja dapat dikelola dengan baik oleh pengguna. Kedepannya, aplikasi ini dapat dikembangkan lebih lanjut sehingga fitur pencarian tidak hanya berdasarkan latar belakang edukasi dan domisili, namun dapat dilakukan filter atau sort dengan kategori latar belakang yang lebih banyak pula. Pengguna (Human Resource) juga bisa mendapatkan suggested person berdasarkan riwayat pencarian orang sebelumnya dengan mengimplementasikan Sistem Rekomendasi dengan Machine Learning (Artificial Intelligence) pada fitur pencariannya. Diharapkan dengan pengembangan aplikasi lebih lanjut, pengguna (Human Resource) dapat melakukan proses scouting calon pekerja dengan lebih efektif dan efisien. Adapun to-do-list dapat dikembangkan lebih jauh lagi pula bukan hanya untuk proses scouting, melainkan untuk proses internal lain didalam perusahaan seperti pembagian tugas pada sprint, dan lain-lain.
